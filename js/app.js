...
Enemy.prototype.update = function( dt ) {
    ...
    */
    if( ( playerXMin >= enemyXMin && playerXMin <= enemyXMax )
        || ( playerXMax <= enemyXMax && playerXMax >= enemyXMin ) ){
        /**
            Check If Enemy and Player Y-Coordinates Overlap
        */
        if (  (playerYMin >= enemyYMin && playerYMin <= enemyYMax )
            || ( playerYMax <= enemyYMax && playerYMax >= enemyYMin) ){
            /*
                We have A Collision!
